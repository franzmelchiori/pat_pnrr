...
if __name__ == '__main__':
    # print_report_comunale(name_comune = 'Trento', version = 'v5.7.1', version_file_to_remove = 'v5.7.0')
    # print_report_comunale(name_comune = 'Ala', version = 'v5.7.1', version_to_remove = 'v5.7.0')
    print_report_comunali(version = 'v5.7.1', version_to_remove = 'v5.7.0')
